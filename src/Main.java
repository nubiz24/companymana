...
// Tạo các nhân viên
    Manager manager1 = new Manager(1, "John Doe", 5000, "123456789", "john.doe@email.com", null, 1000);
    Manager manager2 = new Manager(2, "Jane Miller", 5200, "987654321", "jane.miller@email.com", null, 1200);
    Manager manager3 = new Manager(3, "Richard Roe", 5300, "444444444", "richard.roe@email.com", null, 1100);

    Engineer engineer1 = new Engineer(4, "Alice Smith", 4000, "555555555", "alice.smith@email.com", null, 20, 50);
    Engineer engineer2 = new Engineer(5, "Bob Johnson", 4200, "111111111", "bob.johnson@email.com", null, 15, 60);
    Engineer engineer3 = new Engineer(6, "Charlie Brown", 4300, "222222222", "charlie.brown@email.com", null, 10, 55);
    Engineer engineer4 = new Engineer(7, "Diana Prince", 4100, "333333333", "diana.prince@email.com", null, 25, 65);
    Engineer engineer5 = new Engineer(8, "Eve Adams", 4500, "666666666", "eve.adams@email.com", null, 30, 70);
    Engineer engineer6 = new Engineer(9, "Frank Wright", 4400, "777777777", "frank.wright@email.com", null, 20, 75);
...
// Kết thúc việc thêm dữ liệu
    ...
    // In ra thông tin các thành viên là Engineer trong phòng ban
    System.out.println("Danh sách kỹ sư trong phòng ban: " + engineeringDept.getName());
    ObservableList<Engineer> members = engineeringDept.getMembers();
    for (Employee member : members) {
        if (member instanceof Engineer) {
            Engineer engineer = (Engineer) member; // Chuyển đổi sang Engineer
            System.out.println("ID: " + engineer.getId() + ", Name: " + engineer.getName() +
                    ", Phone: " + engineer.getPhone() + ", Email: " + engineer.getEmail() +
                    ", Base Salary: " + engineer.getBaseSalary());
        }
    }
